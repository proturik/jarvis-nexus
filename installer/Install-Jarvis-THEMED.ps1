...
$InstalledThemeScript = Join-Path $env:LOCALAPPDATA 'JARVIS NEXUS ULTRA\app\windows-theme\Enable-Nexus-Desktop.ps1'
...
function Enable-NexusDesktop {
    if (-not (Test-Path -LiteralPath $InstalledThemeScript -PathType Leaf)) {
        throw "Installed NEXUS desktop module missing: $InstalledThemeScript"
    }
    & $InstalledThemeScript -Mode Apply
...
function Show-NexusInstaller {
    ...
    [xml]$xaml = @'
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation" xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml" Title="JARVIS NEXUS ULTRA" Height="505" Width="760" WindowStyle="None" ResizeMode="NoResize" WindowStartupLocation="CenterScreen" Background="#050A14" Foreground="#DDFBFF">
  <Grid Margin="1">
      ...
      <Grid>
        ...
        <Grid>
          ...
          <StackPanel Width="510" HorizontalAlignment="Left">
            ...
            <Border Margin="0,25,0,12" Padding="17" Background="#101C2E" CornerRadius="8" BorderBrush="#294B68" BorderThickness="1">
              <StackPanel>
            ...
            <CheckBox x:Name="ApplyTheme" IsChecked="True" Content="Apply JARVIS NEXUS wallpaper and dark theme for this Windows user" Margin="2,5" Foreground="#DDFBFF"/>
            <TextBlock x:Name="Status" Margin="2,14,0,0" Text="READY // NEXUS THEME IS OPTIONAL" Foreground="#65F7FF" FontWeight="SemiBold"/>
          </StackPanel>
        </Grid>
...
'@
    ...
    $applyTheme = $window.FindName('ApplyTheme'); $installButton = $window.FindName('InstallButton'); $closeButton = $window.FindName('CloseButton'); $halo = $window.FindName('Halo')
